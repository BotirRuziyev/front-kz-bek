<template>
  <div class="your-transactions">
    <div class="your-transactions__head">
    ...
    <div class="your-transactions__card">
      <div class="card-item card-expenses">
        <h4 class="transaction-title">Your Expenses MTD</h4>
        <h2 class="transaction-amount">$10,000</h2>
      </div>
      <div class="card-item card-deposit">
        <h4 class="transaction-title">Your Deposits MTD</h4>
...
export default class YourTransactions extends Vue {}
</script>
    ...
    .card-item {
      ...
      &.card-expenses {
        background: linear-gradient(
          180deg,
          rgba(29, 144, 25, 0) 0%,
          rgba(49, 246, 42, 0.25) 100%
        );
        &::after {
          content: '';
          width: 37px;
          height: 44px;
          background: url('@/assets/svg/transaction-up.svg') no-repeat
            center/contain;
          position: absolute;
          left: 8px;
          bottom: -4px;
