<template>
  <div class="update-email__account">
    <div class="main-container">
      ...
      <form
        v-if="step === 1"
        action="#"
        class="update-email__account-pin-form"
        @submit.prevent="enterPincode"
      >
        <h2 class="update-email__account-title">Email Update</h2>
        <p class="update-email__account-description">
      ...
      <form v-if="step === 2" action="#" class="update-email__account-form">
        <input-oracle
          type="email"
        ...
        <div class="form-button">
          <new-oracle-button
            :to="isValidEmail ? '/moresettings/privacy-security' : ''"
            text="Continue"
...
export default class UpdateEmailPage extends Vue {
  step: number = 1
  isOpenCode = false
  email = ''
